...
namespace RestaurantManagerment
{
    public partial class Tab1_1BanAn : UserControl
    {
        ...
        private void Tab1_1BanAn_Enter(object sender, EventArgs e)
        {
            if (FormActive)
            {
        ...
        private void btnTangSoLuongMonAn_DoubleClick(object sender, EventArgs e)
        {
            btnTangSoLuongMonAn_Click(sender, e);
        }

        private void btnGiamSoLuongMonAn_DoubleClick(object sender, EventArgs e)
        {
            btnGiamSoLuongMonAn_Click(sender, e);
        }
    }
}
