...
namespace DAO
{
    public class DSphieunhap_DAO
    {
        ...
        {
            string chuoiTruyVan = "Select DsPhieuNhap.MaPN,DsPhieuNhap.MaNL,NguyenLieu.TenNL,NguyenLieu.DonVi,DsPhieuNhap.SoLuong,DsPhieuNhap.DonGia,DsPhieuNhap.NgayNhap,DsPhieuNhap.CungCap,DsPhieuNhap.ThuKho From DsPhieuNhap,NguyenLieu Where DsPhieuNhap.MaNL = NguyenLieu.MaNL";
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                phieunhap.Ngaynhap = dt.Rows[i]["NgayNhap"].ToString();
